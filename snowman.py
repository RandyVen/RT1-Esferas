...
#materials
snow = Material(diffuse=color(255,255,255)) 
eye = Material(diffuse=color(200,200,200)) 
black = Material(diffuse=color(0,0,0)) 
mouth= Material(diffuse=(color(128,128,128))) 
nose = Material(diffuse=(color(255,166,0))) 
#body
...
r.scene.append( Sphere(V3(-0.40, 3.1, -9), 0.2, eye) )
r.scene.append( Sphere(V3(0.4, 3.15, -8.9), 0.1, black) )
r.scene.append( Sphere(V3(-0.40, 3.15, -8.9), 0.1, black) )
#nose
